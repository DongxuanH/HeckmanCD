...
train_data, user_num, item_num, train_mat = data_utils.load_a0910("../../data/a0910/train.csv")
valid_data, _, _, valid_mat = data_utils.load_a0910("../../data/a0910/valid.csv")
...
for epoch in range(epochs):
    ...
    if val_acc > best_acc:
        ...
        torch.save(model, f'ncf_mlp_{best_epoch}.pth')
